        ...
        public async Task Handle_ShouldCallGetListPaginatedAsync()
        {
            ...
            _mockReadRepository
                .Setup(r => r.GetListPaginatedAsync(
                    ...
                    true,
                    It.IsAny<CancellationToken>()))
                .ReturnsAsync(new PagedResult<Example>(new List<Example>(), 0, 2, 10));

            _mockMapper
                .Setup(m => m.Map<IEnumerable<GetExamplesPaginatedDto>>(It.IsAny<IEnumerable<Example>>()))
                .Returns(new List<GetExamplesPaginatedDto>());
        ...
        public async Task Handle_WithDifferentPages_ShouldCallWithCorrectParameters(int page, int pageSize)
        {
            ...
            _mockReadRepository
                .Setup(r => r.GetListPaginatedAsync(
                    ...
                    true,
                    It.IsAny<CancellationToken>()))
                .ReturnsAsync(new PagedResult<Example>(new List<Example>(), 0, page, pageSize));
        ...
        public async Task Handle_ShouldRespectCancellationToken()
        {
            ...
            _mockReadRepository
                .Setup(r => r.GetListPaginatedAsync(
                    ...
                    true,
                    cancellationToken))
                .ReturnsAsync(new PagedResult<Example>(new List<Example>(), 0, 1, 10));
